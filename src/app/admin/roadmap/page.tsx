...
const CADENCE = [
  {
    ...
    color: '#10b981',
    items: [
      'Bug fix: correggere errori segnalati — es. un bottone che non funziona, un\'email che non parte, una pagina che va in errore',
      'Piccoli miglioramenti: cose rapide da fare — es. cambiare un testo, aggiungere un campo, migliorare un messaggio di errore',
      'Nuovi articoli blog (1-2 a settimana per migliorare il posizionamento su Google)',
      'Aggiornamenti testi e contenuti del sito pubblico',
    ],
  },
  {
    icon: '🚀',
    ...
    color: '#6c3df4',
    items: [
      '1-2 funzionalità nuove dalla roadmap (quelle con priorità alta)',
      'Miglioramenti UX: rendere il prodotto più facile da usare basandosi sui feedback — es. un negozio dice "non capisco dove trovare X" → si riorganizza quella sezione',
      'Aggiornamento dipendenze e sicurezza del codice (librerie, pacchetti)',
      'Email ai negozi con le novità del mese — changelog comunicato agli utenti',
      'Review metriche: quanti negozi attivi, quanti hanno cancellato, quanti nuovi',
    ],
  },
  {
    icon: '🏆',
    ...
    color: '#f59e0b',
    items: [
      'Feature major: funzionalità grandi che richiedono settimane di sviluppo (es. Google Wallet, livelli VIP, SMS)',
      'Revisione prezzi e piani se il mercato lo richiede',
      'Analisi churn: capire perché i negozi smettono di pagare e cosa si può fare',
      'Aggiornamento roadmap con nuove priorità in base a cosa chiedono i clienti',
      'Eventuale lancio di un nuovo piano o add-on a pagamento',
    ],
  },
  {
    icon: '🌍',
    ...
    color: '#06b6d4',
    items: [
      'Review completa della strategia prodotto: stiamo andando nella direzione giusta?',
      'Valutazione espansione geografica (Spagna, Francia, Germania)',
      'Eventuale nuovo tier di pricing (es. Enterprise per catene di negozi)',
      'Aggiornamento obbligatorio documenti legali (privacy policy, termini di servizio)',
      'Analisi competitiva: cosa hanno fatto i concorrenti nell\'ultimo anno',
    ],
  },
]
