...
const treatments = [
  ...
  },
  {
    ...
    data: ['Email', 'Dati di fatturazione (gestiti direttamente da Lemon Squeezy come Merchant of Record)'],
    subjects: 'Titolari di negozi con piano a pagamento',
    retention: '10 anni (obblighi fiscali e contabili)',
    processors: ['Lemon Squeezy (Merchant of Record, pagamenti) — USA, GDPR compliant'],
    transfer: 'USA — Lemon Squeezy agisce come Merchant of Record e responsabile autonomo del trattamento per i dati di pagamento',
  },
  {
    id: 5,
