...
export const metadata: Metadata = {
  title: 'Data Processing Agreement — Fidelio',
  description: 'Data Processing Agreement (DPA) ai sensi dell\'art. 28 GDPR tra Fidelio e i negozi che utilizzano il servizio.',
  alternates: { canonical: 'https://www.getfidelio.app/dpa' },
}

export default function DPAPage() {
  return (
    <div style={{ background: '#0D0D1A', color: 'white', minHeight: '100vh', padding: '2rem', fontFamily: 'system-ui', maxWidth: 820, margin: '0 auto' }}>
      <Link href="/" style={{ color: '#a78bfa', textDecoration: 'none', fontSize: '0.85rem' }}>← Torna alla home</Link>

      <h1 style={{ fontSize: '1.8rem', fontWeight: 800, margin: '2rem 0 0.5rem' }}>Data Processing Agreement (DPA)</h1>
      <p style={{ color: 'rgba(255,255,255,0.35)', fontSize: '0.82rem', marginBottom: '0.4rem' }}>Versione 1.0 — 19 aprile 2026 — ai sensi dell&apos;art. 28 GDPR</p>
      <p style={{ color: 'rgba(255,255,255,0.35)', fontSize: '0.82rem', marginBottom: '2.5rem' }}>
        Accettando i <Link href="/termini" style={{ color: '#a78bfa' }}>Termini di Servizio</Link> di Fidelio, il Negozio accetta automaticamente il presente DPA.
      </p>
      ...
      <S title="5. Sub-responsabili del trattamento">
        <P>Fidelio si avvale dei seguenti sub-responsabili. Il Negozio, accettando i Termini di Servizio, presta autorizzazione generale al loro utilizzo:</P>
      ...
      <S title="7. Notifica violazioni (Data Breach)">
        <P>In caso di violazione dei dati personali, Fidelio notificherà il Negozio entro <strong style={{ color: 'white' }}>72 ore</strong> dalla scoperta, fornendo tutte le informazioni disponibili per consentire al Negozio di adempiere al proprio obbligo di notifica al Garante (art. 33 GDPR) e, se necessario, agli Interessati (art. 34 GDPR).</P>
      </S>
      ...
      <div style={{ marginTop: '3rem', borderTop: '1px solid rgba(255,255,255,0.06)', paddingTop: '2rem', fontSize: '0.8rem', color: 'rgba(255,255,255,0.25)' }}>
        Versione 1.0 — 19 aprile 2026 — Fidelio (Antonio Piersante) · <a href="mailto:support@getfidelio.app" style={{ color: 'rgba(255,255,255,0.25)' }}>support@getfidelio.app</a>
      </div>
    </div>
  )
}
